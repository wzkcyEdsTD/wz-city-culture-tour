 ...
 * @LastEditors: eds
 * @Description:
 * @FilePath: \wz-city-culture-tour\src\components\trafficlayer\extraModel\RtmpVideo\RtmpVideo.vue
-->
<template>
  <div class="rtmpVideo">
...
export default {
  ...
  computed: {
    ...mapGetters("traffic", ["rtmpList", "rtmpListOther"]),
    fixRtmpList() {
      const arr = [
  ...
  methods: {
    ...mapActions("traffic", ["SetRtmpList"]),
    //  事件绑定
    eventRegsiter() {
      const that = this;
