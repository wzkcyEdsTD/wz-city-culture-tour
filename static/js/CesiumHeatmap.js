...
function CHInstance(c, bb, o) {
	...
	this._polygon = Cesium.Cartesian3.fromDegreesArray([this.bounds.west, this.bounds.south, this.bounds.west, this.bounds.north, this.bounds.east, this.bounds.north, this.bounds.east, this.bounds.south]);
